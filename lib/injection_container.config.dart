...
import 'data/datasources/authorization_token_local_data_source.dart' as _i15;
import 'data/datasources/banned_device_local_data_source.dart' as _i16;
import 'data/datasources/banned_user_local_data_source.dart' as _i17;
...
import 'data/datasources/verification_code_local_data_source.dart' as _i14;
import 'data/email/emailer.dart' as _i6;
import 'data/email/emailer_impl.dart' as _i7;
import 'data/repositories/authentication_repository_impl.dart' as _i21;
import 'data/repositories/user_repository_impl.dart' as _i13;
import 'data/repositories/verification_code_repository_impl.dart' as _i19;
import 'domain/repositories/authentication_repository.dart' as _i20;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i14.VerificationCodeLocalDataSource>(
      () => _i14.VerificationCodeLocalDataSourceImpl(get<_i3.Database>()));
  gh.factory<_i15.AuthorizationTokenLocalDataSource>(
      () => _i15.AuthorizationTokenLocalDataSourceImpl(get<_i3.Database>()));
  gh.factory<_i16.BannedDeviceLocalDataSource>(
      () => _i16.BannedDeviceLocalDataSourceImpl(get<_i3.Database>()));
  gh.factory<_i17.BannedUserLocalDataSource>(
      () => _i17.BannedUserLocalDataSourceImpl(get<_i3.Database>()));
  gh.factory<_i18.VerificationCodeRepository>(() =>
      _i19.VerificationCodeRepositoryImpl(
          emailer: get<_i6.Emailer>(),
          bannedUserLocalDataSource: get<_i17.BannedUserLocalDataSource>(),
          bannedDeviceLocalDataSource: get<_i16.BannedDeviceLocalDataSource>(),
          userLocalDataSource: get<_i11.UserLocalDataSource>(),
          verificationCodeLocalDataSource:
              get<_i14.VerificationCodeLocalDataSource>()));
  gh.factory<_i20.AuthenticationRepository>(() => _i21.AuthenticationImpl(
      emailer: get<_i6.Emailer>(),
      ...
      authorizationTokenLocalDataSource:
          get<_i15.AuthorizationTokenLocalDataSource>(),
