...
final $typed_data.Uint8List listBusinessRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List listBusinessResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0QnVzaW5lc3NSZXNwb25zZRIlCghidXNpbmVzcxgBIAMoCzIJLkJ1c2luZXNzUghidXNpbmVzcw==');
...
final $typed_data.Uint8List businessDescriptor = $convert.base64Decode(
    'CghCdXNpbmVzcxIOCgJpZBgBIAEoCVICaWQSEgoEbmFtZRgCIAEoCVIEbmFtZQ==');
...
final $typed_data.Uint8List repeatedBusinessDescriptor = $convert.base64Decode(
    'ChBSZXBlYXRlZEJ1c2luZXNzEiUKCGJ1c2luZXNzGAEgAygLMgkuQnVzaW5lc3NSCGJ1c2luZXNz');
...
final $typed_data.Uint8List businessCategoryDescriptor = $convert.base64Decode(
    'ChBCdXNpbmVzc0NhdGVnb3J5Eg4KAmlkGAEgASgJUgJpZBISCgRuYW1lGAIgASgJUgRuYW1l');
