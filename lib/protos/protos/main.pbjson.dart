...
final $typed_data.Uint8List verificationCodeTypeDescriptor = $convert.base64Decode(
    'ChRWZXJpZmljYXRpb25Db2RlVHlwZRImCiJWRVJJRklDQVRJT05fQ09ERV9UWVBFX1VOU1BFQ0lGSUVEEAASCwoHU0lHTl9JThABEgsKB1NJR05fVVAQAhIVChFDSEFOR0VfVVNFUl9FTUFJTBAD');
...
final $typed_data.Uint8List platformTypeDescriptor = $convert.base64Decode(
    'CgxQbGF0Zm9ybVR5cGUSHQoZUExBVEZPUk1fVFlQRV9VTlNQRUNJRklFRBAAEgcKA0lPUxABEgsKB0FORFJPSUQQAg==');
...
final $typed_data.Uint8List appTypeDescriptor = $convert.base64Decode(
    'CgdBcHBUeXBlEhgKFEFQUF9UWVBFX1VOU1BFQ0lGSUVEEAASBwoDQVBQEAESEAoMQlVTSU5FU1NfQVBQEAI=');
...
final $typed_data.Uint8List createVerificationCodeRequestDescriptor =
    $convert.base64Decode(
        'Ch1DcmVhdGVWZXJpZmljYXRpb25Db2RlUmVxdWVzdBIUCgVlbWFpbBgBIAEoCVIFZW1haWwSKQoEdHlwZRgCIAEoDjIVLlZlcmlmaWNhdGlvbkNvZGVUeXBlUgR0eXBlEjgKCWZpZWxkTWFzaxgDIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5GaWVsZE1hc2tSCWZpZWxkTWFzaw==');
...
final $typed_data.Uint8List createVerificationCodeResponseDescriptor =
    $convert.base64Decode(
        'Ch5DcmVhdGVWZXJpZmljYXRpb25Db2RlUmVzcG9uc2USPQoQdmVyaWZpY2F0aW9uQ29kZRgBIAEoCzIRLlZlcmlmaWNhdGlvbkNvZGVSEHZlcmlmaWNhdGlvbkNvZGU=');
...
final $typed_data.Uint8List listVerificationCodeRequestDescriptor =
    $convert.base64Decode(
        'ChtMaXN0VmVyaWZpY2F0aW9uQ29kZVJlcXVlc3QSOAoJZmllbGRNYXNrGAEgASgLMhouZ29vZ2xlLnByb3RvYnVmLkZpZWxkTWFza1IJZmllbGRNYXNr');
...
final $typed_data.Uint8List listVerificationCodeResponseDescriptor =
    $convert.base64Decode(
        'ChxMaXN0VmVyaWZpY2F0aW9uQ29kZVJlc3BvbnNlEj0KEHZlcmlmaWNhdGlvbkNvZGUYASADKAsyES5WZXJpZmljYXRpb25Db2RlUhB2ZXJpZmljYXRpb25Db2Rl');
...
final $typed_data.Uint8List deleteVerificationCodeRequestDescriptor =
    $convert.base64Decode(
        'Ch1EZWxldGVWZXJpZmljYXRpb25Db2RlUmVxdWVzdBIOCgJpZBgBIAEoCVICaWQ=');
...
final $typed_data.Uint8List getVerificationCodeRequestDescriptor =
    $convert.base64Decode(
        'ChpHZXRWZXJpZmljYXRpb25Db2RlUmVxdWVzdBIOCgJpZBgBIAEoCVICaWQSEgoEY29kZRgCIAEoCVIEY29kZRI4CglmaWVsZE1hc2sYBSABKAsyGi5nb29nbGUucHJvdG9idWYuRmllbGRNYXNrUglmaWVsZE1hc2s=');
...
final $typed_data.Uint8List getVerificationCodeResponseDescriptor =
    $convert.base64Decode(
        'ChtHZXRWZXJpZmljYXRpb25Db2RlUmVzcG9uc2USPQoQdmVyaWZpY2F0aW9uQ29kZRgBIAEoCzIRLlZlcmlmaWNhdGlvbkNvZGVSEHZlcmlmaWNhdGlvbkNvZGU=');
...
final $typed_data.Uint8List updateVerificationCodeRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List updateVerificationCodeResponseDescriptor =
    $convert.base64Decode(
        'Ch5VcGRhdGVWZXJpZmljYXRpb25Db2RlUmVzcG9uc2USPQoQdmVyaWZpY2F0aW9uQ29kZRgBIAEoCzIRLlZlcmlmaWNhdGlvbkNvZGVSEHZlcmlmaWNhdGlvbkNvZGU=');
...
final $typed_data.Uint8List signInRequestDescriptor = $convert.base64Decode(
    'Cg1TaWduSW5SZXF1ZXN0EhQKBWVtYWlsGAEgASgJUgVlbWFpbBISCgRjb2RlGAIgASgJUgRjb2RlEjgKCWZpZWxkTWFzaxgDIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5GaWVsZE1hc2tSCWZpZWxkTWFzaw==');
...
final $typed_data.Uint8List signInResponseDescriptor = $convert.base64Decode(
    'Cg5TaWduSW5SZXNwb25zZRIiCgxyZWZyZXNoVG9rZW4YASABKAlSDHJlZnJlc2hUb2tlbhIuChJhdXRob3JpemF0aW9uVG9rZW4YAiABKAlSEmF1dGhvcml6YXRpb25Ub2tlbhIZCgR1c2VyGAMgASgLMgUuVXNlclIEdXNlcg==');
...
final $typed_data.Uint8List hostnameRequestDescriptor =
    $convert.base64Decode('Cg9Ib3N0bmFtZVJlcXVlc3Q=');
...
const HealthCheckResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.HealthCheckResponse.ServingStatus',
      '10': 'status'
    },
  ],
...
final $typed_data.Uint8List healthCheckResponseDescriptor = $convert.base64Decode(
    'ChNIZWFsdGhDaGVja1Jlc3BvbnNlEjoKBnN0YXR1cxgBIAEoDjIiLkhlYWx0aENoZWNrUmVzcG9uc2UuU2VydmluZ1N0YXR1c1IGc3RhdHVzIjoKDVNlcnZpbmdTdGF0dXMSCwoHVU5LTk9XThAAEgsKB1NFUlZJTkcQARIPCgtOT1RfU0VSVklORxAC');
...
final $typed_data.Uint8List userDescriptor = $convert.base64Decode(
    '');
...
const BannedUser$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'moderatorAuthorizationTokenFk',
      '3': 5,
      '4': 1,
      '5': 9,
      '10': 'moderatorAuthorizationTokenFk'
    },
...
final $typed_data.Uint8List bannedUserDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List bannedDeviceDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List authorizationTokenDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List refreshTokenDescriptor = $convert.base64Decode(
    '');
...
const Device$json = const {
  ...
  '2': const [
    ...
    const {'1': 'deviceId', '3': 4, '4': 1, '5': 9, '10': 'deviceId'},
    const {
      '1': 'firebaseCloudMessagingId',
      '3': 5,
      '4': 1,
      '5': 9,
      '10': 'firebaseCloudMessagingId'
    },
...
final $typed_data.Uint8List deviceDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List userAddressDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List userPermissionDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List polygonDescriptor = $convert.base64Decode(
    'CgdQb2x5Z29uEiAKC2Nvb3JkaW5hdGVzGAEgAygBUgtjb29yZGluYXRlcw==');
...
final $typed_data.Uint8List verificationCodeDescriptor = $convert.base64Decode(
    '');
