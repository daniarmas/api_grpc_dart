...
class ListBusinessRequest extends $pb.GeneratedMessage {
  ...
  ListBusinessRequest copyWith(void Function(ListBusinessRequest) updates) =>
      super.copyWith((message) => updates(message as ListBusinessRequest))
          as ListBusinessRequest; // ignore: deprecated_member_use
...
class ListBusinessResponse extends $pb.GeneratedMessage {
  ...
  ListBusinessResponse copyWith(void Function(ListBusinessResponse) updates) =>
      super.copyWith((message) => updates(message as ListBusinessResponse))
          as ListBusinessResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Business extends $pb.GeneratedMessage {
  ...
  Business copyWith(void Function(Business) updates) =>
      super.copyWith((message) => updates(message as Business))
          as Business; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RepeatedBusiness extends $pb.GeneratedMessage {
  ...
  factory RepeatedBusiness.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RepeatedBusiness.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  RepeatedBusiness copyWith(void Function(RepeatedBusiness) updates) =>
      super.copyWith((message) => updates(message as RepeatedBusiness))
          as RepeatedBusiness; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static RepeatedBusiness create() => RepeatedBusiness._();
  RepeatedBusiness createEmptyInstance() => create();
  static $pb.PbList<RepeatedBusiness> createRepeated() =>
      $pb.PbList<RepeatedBusiness>();
  @$core.pragma('dart2js:noInline')
  static RepeatedBusiness getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RepeatedBusiness>(create);
...
class BusinessCategory extends $pb.GeneratedMessage {
  ...
  factory BusinessCategory.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BusinessCategory.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  BusinessCategory copyWith(void Function(BusinessCategory) updates) =>
      super.copyWith((message) => updates(message as BusinessCategory))
          as BusinessCategory; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static BusinessCategory create() => BusinessCategory._();
  BusinessCategory createEmptyInstance() => create();
  static $pb.PbList<BusinessCategory> createRepeated() =>
      $pb.PbList<BusinessCategory>();
  @$core.pragma('dart2js:noInline')
  static BusinessCategory getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BusinessCategory>(create);
